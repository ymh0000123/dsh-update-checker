...
function parseGithubFromLockfile(profileDir) {
  ...
  const add = (name, resolved, specifier) => {
    ...
    seen.set(name, {
      ...
      kind: 'github-dep',
      specifier: specifier === undefined ? undefined : String(specifier).trim(),
...
module.exports = { runCheck, renderReport, findProfile, cmp, maxOf, parseGithubFromLockfile, githubFromResolution };
